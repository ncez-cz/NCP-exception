...
namespace EMapper.Convertor.DastaHL7.CDAConvertor.Wave4
{
    public class W4DastaMapper
    {
        ...
        private char ConvertDuvernostToCdaCECode(byte value)
        {
            switch (value)
            {
                case 1:
...
//            var offsetShifted = new DateTimeOffset(shifted,TimeSpan.Zero);
            ...
            var icz = string.IsNullOrWhiteSpace(relevatntKuz.zpo.icz)
        ...
        private POCD_MT000040Patient GetPatient(ku_zType patsumKuz)
        {
            ...
            return new POCD_MT000040Patient
            {
                ...
                birthTime = birthTime,
                guardian = guardian,
                languageCommunication = cdaLanguages
            };
        }
        ...
        private II[] GetRecordTargetIdentifiers(dasta dasta)
        {
            ...
            if (kuzType.FirstOrDefault() != null)
                identifiers.Add(new II
                {
                    ...
                    assigningAuthorityName = dasta.GetInfoPatient().ku.Items.OfType<ku_zType>()
                        .First(x => x.typku == "PATSUM.DAT").zpo.nazev
                });
