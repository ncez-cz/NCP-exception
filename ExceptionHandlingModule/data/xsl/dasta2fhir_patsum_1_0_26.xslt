...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ns0="http://hl7.org/fhir" xmlns:provisio="http://www.altova.com/MapForce/UDF/provisio" xmlns:vmf="http://www.altova.com/MapForce/UDF/vmf" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:ns1="urn:cz-mzcr:ns:dasta:ds4:ds_dasta" xmlns:ns2="urn:cz-mzcr:ns:dasta:ds4:ds_ip" exclude-result-prefixes="ns0 provisio vmf xs fn ns1 ns2">
	...
	<xsl:template name="provisio:ip">
		...
		<xsl:variable name="var3_resultof_le___all" as="node()*">
			<xsl:call-template name="provisio:le_-_all">
				...
				<xsl:with-param name="ip_le" select="$var93_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_le" select="$var71_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
		...
		<xsl:variable name="var6_resultof_u___all" as="node()*">
			<xsl:call-template name="provisio:u_-_all">
				...
				<xsl:with-param name="ip_u" select="$var88_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="dat_prov" select="$var81_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_u" select="$var75_map_of_ip" as="node()*"/>
			</xsl:call-template>
		</xsl:variable>
		<xsl:variable name="var9_resultof_fs___all" as="node()*">
			<xsl:call-template name="provisio:fs_-_all">
				...
				<xsl:with-param name="ip_fs" select="$var91_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_fs" select="$var68_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="dat_prov" select="$var81_map_of_ip" as="node()*"/>
			</xsl:call-template>
		...
		<xsl:variable name="var12_resultof_ld___all" as="node()*">
			<xsl:call-template name="provisio:ld_-_all">
				...
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="ip_ld" select="$var86_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_ld" select="$var79_map_of_ip" as="node()*"/>
				<xsl:with-param name="dat_prov" select="$var81_map_of_ip" as="node()*"/>
			</xsl:call-template>
		</xsl:variable>
		<xsl:variable name="var15_resultof_chv___all" as="node()*">
			<xsl:call-template name="provisio:chv_-_all">
				...
				<xsl:with-param name="ip_chv" select="$var92_map_of_ip" as="node()*"/>
				...
				<xsl:with-param name="patsudat_chv" select="$var73_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="dat_prov" select="$var81_map_of_ip" as="node()*"/>
			</xsl:call-template>
		...
		<xsl:variable name="var18_resultof_oc___all" as="node()*">
			<xsl:call-template name="provisio:oc_-_all">
				...
				<xsl:with-param name="dat_prov" select="$var81_map_of_ip" as="node()*"/>
				<xsl:with-param name="ip_oc" select="$var90_map_of_ip" as="node()*"/>
		...
		<xsl:variable name="var21_resultof_h___all" as="node()*">
			<xsl:call-template name="provisio:h_-_all">
				...
				<xsl:with-param name="dat_prov" select="$var81_map_of_ip" as="node()*"/>
				<xsl:with-param name="ip_h" select="$var94_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_h" select="$var70_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
			</xsl:call-template>
		</xsl:variable>
		<xsl:variable name="var24_resultof_fyznal___all" as="node()*">
			<xsl:call-template name="provisio:fyznal_-_all">
				...
				<xsl:with-param name="ip_fyznal" select="$var85_map_of_ip" as="node()*"/>
		...
		<xsl:variable name="var30_resultof_an___all" as="node()*">
			<xsl:call-template name="provisio:an_-_all">
				...
				<xsl:with-param name="dat_prov" select="$var81_map_of_ip" as="node()*"/>
				<xsl:with-param name="ip_an" select="$var87_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_an" select="$var72_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
			</xsl:call-template>
		</xsl:variable>
		<xsl:variable name="var33_resultof_grav___all" as="node()*">
			<xsl:call-template name="provisio:grav_-_all">
				...
				<xsl:with-param name="patsumdat_grav" select="$var76_map_of_ip" as="node()*"/>
				<xsl:with-param name="dat_prov" select="$var81_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
			</xsl:call-template>
		...
		<xsl:variable name="var42_resultof_anf___all" as="node()*">
			<xsl:call-template name="provisio:anf_-_all">
				...
				<xsl:with-param name="ip_anf" select="$var84_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="patsumdat_anf" select="$var78_map_of_ip" as="node()*"/>
				<xsl:with-param name="dat_prov" select="$var81_map_of_ip" as="node()*"/>
			</xsl:call-template>
		</xsl:variable>
		...
		<xsl:variable name="var51_resultof_dg___all" as="node()*">
			<xsl:call-template name="provisio:dg_-_all">
				...
				<xsl:with-param name="ip_dg" select="$var83_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_dg" select="$var77_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="dat_prov" select="$var81_map_of_ip" as="node()*"/>
			</xsl:call-template>
	...
	<xsl:template name="provisio:garant_dat">
		...
		<xsl:for-each select="$garant_dat">
			...
			<xsl:variable name="var6_vguid" as="node()?" select="@vguid"/>
			<xsl:variable name="var7_guid" as="node()?" select="@guid"/>
			<entry xmlns="http://hl7.org/fhir">
				<fullUrl>
					<xsl:for-each select="$var7_guid">
			...
			<xsl:for-each select="$var14_dasta/ns1:is/ns2:ip">
				<xsl:variable name="var4_resultof_is" as="node()*">
					<xsl:call-template name="provisio:is">
						<xsl:with-param name="is" select="$var12_map_of_dasta" as="node()*"/>
					</xsl:call-template>
				</xsl:variable>
				<xsl:variable name="var8_resultof_garant_dat" as="node()*">
					<xsl:call-template name="provisio:garant_dat">
						<xsl:with-param name="garant_dat" select="$var13_map_of_dasta" as="node()?"/>
					</xsl:call-template>
				</xsl:variable>
