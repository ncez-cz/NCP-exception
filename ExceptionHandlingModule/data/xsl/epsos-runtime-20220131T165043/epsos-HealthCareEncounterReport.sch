   ...
   <pattern>
      ...
      <rule fpi="RUL-EXPEL" context="/">
         <assert role="warning"
                 ...
                 see="https://art-decor.ehdsi.eu/publication/epSOS/epsos-html-20220131T165043/tmp-1.3.6.1.4.1.12559.11.10.1.3.1.1.5-2018-11-14T090313.html">(epSOS-MRO): Instance is expected to have the following element: descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '1.3.6.1.4.1.12559.11.10.1.3.1.1.5']]</assert>
      </rule>
   </pattern>
