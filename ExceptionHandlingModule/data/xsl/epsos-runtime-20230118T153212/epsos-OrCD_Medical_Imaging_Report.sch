...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Schematron file for transaction Return OrCD Medical Imaging Report of country A (2.16.840.1.113883.3.1937.777.11.4.44 2021-04-30T11:27:45)</title>
   ...
   <!-- Include the project schematrons related to scenario OrCD_Medical_Imaging_Report -->

   <!-- eHDSIOrCDMedicalImagingReport -->
   <pattern>
      <title>eHDSIOrCDMedicalImagingReport</title>
      <rule fpi="RUL-EXPEL" context="/">
         <assert role="warning"
                 test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '1.3.6.1.4.1.12559.11.10.1.3.1.1.10']]"
                 see="https://art-decor.ehdsi.eu/publication/epSOS/epsos-html-20230118T153212/tmp-1.3.6.1.4.1.12559.11.10.1.3.1.1.10-2022-09-12T134207.html">(eHDSIOrCDMedicalImagingReport): Instance is expected to have the following element: descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '1.3.6.1.4.1.12559.11.10.1.3.1.1.10']]</assert>
      </rule>
   </pattern>
   <include href="include/1.3.6.1.4.1.12559.11.10.1.3.1.1.10-2022-09-12T134207.sch"/>
   <include href="include/1.3.6.1.4.1.12559.11.10.1.3.1.1.10-2022-09-12T134207-closed.sch"/>
