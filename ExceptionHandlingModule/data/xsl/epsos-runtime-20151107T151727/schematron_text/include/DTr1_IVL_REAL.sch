...
<rule xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <assert role="error"
           test="not(hl7:low/@value and hl7:high/@value) or hl7:low/number(@value) &lt;= hl7:high/number(@value)">dtr1-7-IVL_REAL: low/@value must be lower than or equal to high/@value</assert>
