...
<rule xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <assert test="empty($theTS) or ($theTS=$theTSString and $theDateTime castable as xs:dateTime)">dtr1-2-TS: <value-of select="local-name()"/> "<value-of select="$theTS"/>" is not a valid timestamp.</assert>
</rule>
