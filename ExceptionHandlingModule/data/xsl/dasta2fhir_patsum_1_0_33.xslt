...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ns0="http://hl7.org/fhir" xmlns:provisio="http://www.altova.com/MapForce/UDF/provisio" xmlns:vmf="http://www.altova.com/MapForce/UDF/vmf" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:ns1="urn:cz-mzcr:ns:dasta:ds4:ds_dasta" xmlns:ns2="urn:cz-mzcr:ns:dasta:ds4:ds_ip" exclude-result-prefixes="ns0 provisio vmf xs fn ns1 ns2">
				...
				<resource>
					<FamilyMemberHistory>
						...
						<xsl:for-each select="ns2:rao_zdrprob_kod">
							<xsl:variable name="var2_https___dasta_mzcr_cz_WWBWI_ht_as_string" as="xs:string" select="xs:string(xs:anyURI('https://dasta.mzcr.cz/WWBWI.htm'))"/>
							<condition>
								<code>
									<coding>
										<system>
											<xsl:attribute name="value" namespace="" select="$var2_https___dasta_mzcr_cz_WWBWI_ht_as_string"/>
										</system>
										<version>
	...
	<xsl:template name="provisio:anf_anam_inf">
		...
		<xsl:for-each select="$anam_infType">
			...
			<xsl:variable name="var3_guid" as="node()?" select="@guid"/>
			<xsl:variable name="var4_http___snomed_info_sct_as_string" as="xs:string" select="xs:string(xs:anyURI('http://snomed.info/sct'))"/>
			<xsl:variable name="var5_inf_expoz_kod" as="node()*" select="ns2:inf_expoz_kod"/>
			<xsl:variable name="var6_inf_agens" as="node()*" select="ns2:inf_agens"/>
			<entry xmlns="http://hl7.org/fhir">
				<xsl:for-each select="$var3_guid">
					<fullUrl>
						<xsl:attribute name="value" namespace="" select="xs:string(xs:anyURI(fn:concat('urn:uuid:', fn:string(.))))"/>
				...
				<resource>
					<Observation>
						...
						<code>
							<coding>
								<system>
									<xsl:attribute name="value" namespace="" select="$var4_http___snomed_info_sct_as_string"/>
								</system>
								<xsl:for-each select="$var6_inf_agens/ns2:kod">
									<code>
										<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
									</code>
								</xsl:for-each>
								<display>
									<xsl:for-each select="$var6_inf_agens/ns2:kod_text">
										<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
									</xsl:for-each>
								</display>
							</coding>
			...
			<entry xmlns="http://hl7.org/fhir">
				...
				<resource>
					<Composition>
						...
						<meta>
							<profile>
								<xsl:attribute name="value" namespace="" select="xs:string(xs:anyURI('http://hl7.eu/fhir/eps/StructureDefinition/composition-eu-eps'))"/>
							</profile>
						</meta>
						<status>
							<xsl:attribute name="value" namespace="" select="'final'"/>
						...
						<section>
							...
							<xsl:if test="fn:not(fn:exists($sectionSocialHistory_anf_rao))">
	...
	<xsl:template name="provisio:ua">
		...
		<xsl:for-each select="$uaType">
			...
			<xsl:variable name="var13_dat_ab" as="node()?" select="@dat_ab"/>
			<xsl:variable name="var14_uaf" as="node()*" select="ns2:uaf"/>
			<xsl:variable name="var12_test_resultof_any" as="xs:string*">
				<xsl:choose>
					<xsl:when test="fn:exists(($var14_uaf)[fn:exists(@guid)])">
						<xsl:for-each select="$var14_uaf/@guid">
							<xsl:sequence select="fn:string(.)"/>
						</xsl:for-each>
					</xsl:when>
					<xsl:otherwise>
					...
					<AllergyIntolerance>
						...
						<meta>
							<xsl:variable name="var2_test_resultof_any" as="xs:string*">
								<xsl:choose>
									<xsl:when test="fn:exists(($var14_uaf)[fn:exists(@vguid)])">
										<xsl:for-each select="$var14_uaf/@vguid">
											<xsl:sequence select="fn:string(.)"/>
										</xsl:for-each>
									</xsl:when>
									<xsl:otherwise>
							...
							<profile>
								<xsl:attribute name="value" namespace="" select="xs:string(xs:anyURI('https://fhir.hl7cr.eu/fhir/core/StructureDefinition/cz-allergyIntolerance'))"/>
							</profile>
						</meta>
						<text>
							<status>
						...
						<xsl:for-each select="$var14_uaf/@typ_reakce">
							<xsl:variable name="var5_resultof_vmf___inputtoresult" as="xs:string?">
						...
						<xsl:for-each select="$var14_uaf/@typ_agens">
						...
						<xsl:for-each select="$var14_uaf/@szp_klic">
	...
	<xsl:template name="provisio:urf">
		...
		<xsl:for-each select="$urfType">
			...
			<entry xmlns="http://hl7.org/fhir">
				<xsl:for-each select="$var7_urff/@guid">
					<xsl:variable name="var1_resultof_FullURL_Flag" as="xs:string?">
						<xsl:call-template name="provisio:FullURL_Flag">
							<xsl:with-param name="GUID" select="fn:string(.)" as="xs:string"/>
						</xsl:call-template>
				...
				<resource>
					<Flag>
						...
						<meta>
							<xsl:for-each select="$var7_urff/@vguid">
								<versionId>
									<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
								</versionId>
							</xsl:for-each>
	...
	<xsl:template name="provisio:uks">
		...
		<xsl:for-each select="$uksType">
			...
			<xsl:variable name="var6_ks_rh" as="node()*" select="ns2:ks_rh"/>
			...
			<entry xmlns="http://hl7.org/fhir">
				...
				<resource>
					<Observation>
						...
						<xsl:variable name="var3_test_resultof_exists" as="xs:string*">
							<xsl:choose>
								<xsl:when test="fn:exists($var6_ks_rh)">
									<xsl:for-each select="$var6_ks_rh">
										<xsl:sequence select="fn:string(.)"/>
									</xsl:for-each>
								</xsl:when>
								<xsl:otherwise>
	...
	<xsl:template name="provisio:le">
		...
		<xsl:for-each select="$leType">
			...
			<xsl:for-each select="ns2:lez">
				<xsl:variable name="var9_cur" as="node()" select="."/>
				<xsl:variable name="var6_dat_ab" as="node()?" select="$var10_cur/@dat_ab"/>
				<xsl:variable name="var7_kod_atc" as="node()?" select="@kod_atc"/>
				<xsl:variable name="var8_guid" as="node()?" select="@guid"/>
				<entry xmlns="http://hl7.org/fhir">
					<xsl:for-each select="$var8_guid">
						<xsl:for-each select="$var8_guid">
					...
					<resource>
						<MedicationAdministration>
							...
							<xsl:for-each select="ns2:zmena_m_kod">
								<statusReason>
									<coding>
										...
										<display>
											<xsl:for-each select="$var9_cur/ns2:zmena_m_text">
												<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
											</xsl:for-each>
										</display>
									</coding>
							...
							<medicationCodeableConcept>
								...
								<xsl:variable name="var4_test_resultof_exists" as="xs:string*">
									<xsl:choose>
										<xsl:when test="fn:exists($var7_kod_atc)">
											<xsl:sequence select="fn:string($var7_kod_atc)"/>
										</xsl:when>
										<xsl:otherwise>
								...
								<xsl:for-each select="$var4_test_resultof_exists">
									<coding>
										...
										<xsl:for-each select="$var9_cur/ns2:aktivni_latka/@nazev">
											<display>
												<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
											</display>
										</xsl:for-each>
							...
							<xsl:for-each select="ns2:ind_m_kod">
								<reasonCode>
									...
									<xsl:for-each select="$var9_cur/ns2:ind_m_text">
										<text>
											<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
										</text>
									</xsl:for-each>
							...
							<xsl:for-each select="ns2:rozpis_v">
								<dosage>
									<xsl:for-each select="$var9_cur/@misto_apl_klic">
										<site>
											<coding>
												<system>
													<xsl:attribute name="value" namespace="" select="xs:string(xs:anyURI('https://dasta.mzcr.cz/WWBUU.htm'))"/>
												...
												<display>
													<xsl:for-each select="$var9_cur/@misto_apl_text">
														<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
													</xsl:for-each>
												</display>
											</coding>
									...
									<xsl:for-each select="$var9_cur/@apl_cesta_klic">
										<route>
											<coding>
												<system>
													<xsl:attribute name="value" namespace="" select="xs:string(xs:anyURI('https://dasta.mzcr.cz/WWBUT.htm'))"/>
												...
												<display>
													<xsl:for-each select="$var9_cur/@apl_cesta_text">
														<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
													</xsl:for-each>
												</display>
											</coding>
									...
									<xsl:for-each select="$var9_cur/@forma_klic">
										<method>
											<coding>
												<system>
												...
												<display>
													<xsl:for-each select="$var9_cur/@forma_text">
														<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
													</xsl:for-each>
												</display>
											</coding>
	...
	<xsl:template name="provisio:fs">
		...
		<xsl:for-each select="$fsType">
			<xsl:variable name="var5_guid" as="node()?" select="@guid"/>
			<xsl:variable name="var6_typ" as="node()?" select="@typ"/>
	...
	<xsl:template name="provisio:adresa">
		...
		<xsl:variable name="var16_jmeno" as="node()*" select="$a/ns1:jmeno"/>
		<xsl:variable name="var17_typ" as="node()?" select="$a/@typ"/>
		<Address xmlns="http://hl7.org/fhir">
			...
			<xsl:variable name="var7_test_resultof_exists" as="xs:string*">
				<xsl:choose>
					<xsl:when test="fn:exists($var16_jmeno)">
						<xsl:for-each select="$var16_jmeno">
							<xsl:sequence select="fn:string(.)"/>
						</xsl:for-each>
					</xsl:when>
					<xsl:otherwise>
	...
	<xsl:template name="provisio:ip_ip">
		...
		<xsl:for-each select="$ip">
			...
			<xsl:variable name="var71_guid" as="node()?" select="@guid"/>
			<xsl:variable name="var72_a" as="node()*" select="ns1:a"/>
			<xsl:variable name="var73_ipi_o" as="node()*" select="ns2:ipi_o"/>
			<xsl:variable name="var74_vguid" as="node()?" select="@vguid"/>
			<xsl:variable name="var75_ipi_v" as="node()*" select="ns2:ipi_v"/>
			<entry xmlns="http://hl7.org/fhir">
				<xsl:for-each select="$var71_guid">
				...
				<resource>
					<Patient>
						...
						<meta>
							<xsl:for-each select="$var74_vguid">
								<versionId>
									<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
								</versionId>
							</xsl:for-each>
						...
						<xsl:for-each select="$var73_ipi_o/@nem_cis">
							<identifier>
								<use>
									<xsl:attribute name="value" namespace="" select="'official'"/>
								</use>
						...
						<xsl:for-each select="$var73_ipi_o/@kat_pac">
							<identifier>
								<use>
									<xsl:attribute name="value" namespace="" select="'official'"/>
								</use>
						...
						<xsl:for-each select="$var73_ipi_o/@cis_chor">
							<identifier>
								<use>
									<xsl:attribute name="value" namespace="" select="'official'"/>
								</use>
						...
						<xsl:for-each select="$var73_ipi_o/@cis_is">
							<identifier>
								<use>
									<xsl:attribute name="value" namespace="" select="'official'"/>
								</use>
						...
						<xsl:for-each select="$var75_ipi_v/@nem_cis">
							<identifier>
								<use>
									<xsl:attribute name="value" namespace="" select="'official'"/>
								</use>
						...
						<xsl:for-each select="$var75_ipi_v/@kat_pac">
							<identifier>
								<use>
									<xsl:attribute name="value" namespace="" select="'official'"/>
								</use>
						...
						<xsl:for-each select="$var75_ipi_v/@cis_chor">
							<identifier>
								<use>
									<xsl:attribute name="value" namespace="" select="'official'"/>
								</use>
						...
						<xsl:for-each select="$var75_ipi_v/@cis_is">
							<identifier>
								<use>
									<xsl:attribute name="value" namespace="" select="'MR'"/>
								</use>
						...
						<xsl:for-each select="ns2:prijmeni">
							<name>
								...
								<xsl:for-each select="$var76_current/ns2:jmeno">
									<given>
										<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
									</given>
								</xsl:for-each>
								<xsl:for-each select="$var76_current/ns2:titul_pred">
									<prefix>
										<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
									</prefix>
								</xsl:for-each>
								<xsl:for-each select="$var76_current/ns2:titul_za">
									<suffix>
										<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
									</suffix>
								</xsl:for-each>
						...
						<xsl:for-each select="$var72_a">
							...
							<xsl:variable name="var12_resultof_filter" as="node()*">
								<xsl:for-each select="ns1:as">
									<xsl:variable name="var11_resultof_filter" as="node()*">
										<xsl:for-each select="$var21_cur/@typ">
											<xsl:variable name="var10_cur_as_string" as="xs:string" select="fn:string(.)"/>
											<xsl:if test="fn:exists(((($var10_cur_as_string = '1'), ($var10_cur_as_string = '2')))[.])">
												<xsl:sequence select="."/>
											</xsl:if>
										</xsl:for-each>
									</xsl:variable>
							...
							<xsl:for-each select="$var12_resultof_filter">
								...
								<telecom>
									...
									<xsl:for-each select="$var13_resultof_adresa_spojeni/@id">
										<xsl:attribute name="id" namespace="" select="fn:string(.)"/>
									</xsl:for-each>
									...
									<xsl:for-each select="$var14_resultof_adresa_spojeni/ns0:extension">
										<extension>
											<xsl:sequence select="(./@node(), ./node())"/>
										</extension>
									</xsl:for-each>
									...
									<xsl:for-each select="$var15_resultof_adresa_spojeni/ns0:system">
										<system>
											<xsl:sequence select="(./@node(), ./node())"/>
										</system>
									</xsl:for-each>
									...
									<xsl:for-each select="$var16_resultof_adresa_spojeni/ns0:value">
										<value>
											<xsl:sequence select="(./@node(), ./node())"/>
										</value>
									</xsl:for-each>
									...
									<xsl:for-each select="$var17_resultof_adresa_spojeni/ns0:use">
										<use>
											<xsl:sequence select="(./@node(), ./node())"/>
										</use>
									</xsl:for-each>
									<xsl:variable name="var18_resultof_adresa_spojeni" as="node()*">
										<xsl:call-template name="provisio:adresa_spojeni">
											<xsl:with-param name="as" as="node()">
												<as xmlns="urn:cz-mzcr:ns:dasta:ds4:ds_dasta">
													<xsl:sequence select="$var20_let"/>
									...
									<xsl:for-each select="$var18_resultof_adresa_spojeni/ns0:rank">
										<rank>
											<xsl:sequence select="(./@node(), ./node())"/>
										</rank>
									</xsl:for-each>
									...
									<xsl:for-each select="$var19_resultof_adresa_spojeni/ns0:period">
										<period>
											<xsl:sequence select="(./@node(), ./node())"/>
										</period>
									</xsl:for-each>
							...
							<xsl:for-each select="$var72_a">
								<xsl:variable name="var24_resultof_filter" as="node()*">
									<xsl:for-each select="@typ">
										...
										<xsl:if test="fn:exists(((($var23_cur_as_string = '1'), ($var23_cur_as_string = '2')))[.])">
											<xsl:sequence select="."/>
										</xsl:if>
									</xsl:for-each>
								</xsl:variable>
								<xsl:if test="fn:exists($var24_resultof_filter)">
									<xsl:sequence select="."/>
								</xsl:if>
							</xsl:for-each>
						</xsl:variable>
						<xsl:for-each select="$var25_resultof_filter">
							<xsl:variable name="var38_let" as="node()*" select="(./@node(), ./node())"/>
							<address>
								...
								<xsl:for-each select="$var26_resultof_adresa/@id">
									<xsl:attribute name="id" namespace="" select="fn:string(.)"/>
								</xsl:for-each>
								...
								<xsl:for-each select="$var27_resultof_adresa/ns0:extension">
									<extension>
										<xsl:sequence select="(./@node(), ./node())"/>
									</extension>
								</xsl:for-each>
								...
								<xsl:for-each select="$var28_resultof_adresa/ns0:use">
									<use>
										<xsl:sequence select="(./@node(), ./node())"/>
									</use>
								</xsl:for-each>
								...
								<xsl:for-each select="$var29_resultof_adresa/ns0:type">
									<type>
										<xsl:sequence select="(./@node(), ./node())"/>
									</type>
								</xsl:for-each>
								...
								<xsl:for-each select="$var30_resultof_adresa/ns0:text">
									<text>
										<xsl:sequence select="(./@node(), ./node())"/>
									</text>
								</xsl:for-each>
								...
								<xsl:for-each select="$var31_resultof_adresa/ns0:line">
									<line>
										<xsl:sequence select="(./@node(), ./node())"/>
									</line>
								</xsl:for-each>
								...
								<xsl:for-each select="$var32_resultof_adresa/ns0:city">
									<city>
										<xsl:sequence select="(./@node(), ./node())"/>
									</city>
								</xsl:for-each>
								...
								<xsl:for-each select="$var33_resultof_adresa/ns0:district">
									<district>
										<xsl:sequence select="(./@node(), ./node())"/>
									</district>
								</xsl:for-each>
								...
								<xsl:for-each select="$var34_resultof_adresa/ns0:state">
									<state>
										<xsl:sequence select="(./@node(), ./node())"/>
									</state>
								</xsl:for-each>
								...
								<xsl:for-each select="$var35_resultof_adresa/ns0:postalCode">
									<postalCode>
										<xsl:sequence select="(./@node(), ./node())"/>
									</postalCode>
								</xsl:for-each>
								<xsl:variable name="var36_resultof_adresa" as="node()?">
									<xsl:call-template name="provisio:adresa">
										<xsl:with-param name="a" as="node()">
											<a xmlns="urn:cz-mzcr:ns:dasta:ds4:ds_dasta">
												<xsl:sequence select="$var38_let"/>
								...
								<xsl:for-each select="$var36_resultof_adresa/ns0:country">
									<country>
										<xsl:sequence select="(./@node(), ./node())"/>
									</country>
								</xsl:for-each>
								<xsl:variable name="var37_resultof_adresa" as="node()?">
									<xsl:call-template name="provisio:adresa">
										<xsl:with-param name="a" as="node()">
											<a xmlns="urn:cz-mzcr:ns:dasta:ds4:ds_dasta">
												<xsl:sequence select="$var38_let"/>
								...
								<xsl:for-each select="$var37_resultof_adresa/ns0:period">
									<period>
										<xsl:sequence select="(./@node(), ./node())"/>
									</period>
								</xsl:for-each>
							...
							<xsl:for-each select="$var72_a">
								<xsl:variable name="var40_resultof_filter" as="node()*">
									<xsl:for-each select="@typ">
										...
										<xsl:if test="fn:exists(((($var39_cur_as_string = 'K'), ($var39_cur_as_string = 'Z')))[.])">
											<xsl:sequence select="."/>
										</xsl:if>
									</xsl:for-each>
								</xsl:variable>
								<xsl:if test="fn:exists($var40_resultof_filter)">
									<xsl:sequence select="."/>
								</xsl:if>
							</xsl:for-each>
						</xsl:variable>
						<xsl:for-each select="$var41_resultof_filter">
							<xsl:variable name="var56_typ" as="node()?" select="@typ"/>
							<contact>
								<relationship>
									<coding>
										<system>
								...
								<xsl:variable name="var46_resultof_filter" as="node()*">
									<xsl:for-each select="ns1:as">
										<xsl:variable name="var45_resultof_filter" as="node()*">
											<xsl:for-each select="$var56_typ">
												<xsl:variable name="var44_cur_as_string" as="xs:string" select="fn:string(.)"/>
												<xsl:if test="fn:exists(((($var44_cur_as_string = 'K'), ($var44_cur_as_string = 'Z')))[.])">
													<xsl:sequence select="."/>
												</xsl:if>
											</xsl:for-each>
										</xsl:variable>
										<xsl:if test="fn:exists($var45_resultof_filter)">
											<xsl:sequence select="."/>
										</xsl:if>
									</xsl:for-each>
								</xsl:variable>
								<xsl:for-each select="$var46_resultof_filter">
									<xsl:variable name="var54_let" as="node()*" select="(./@node(), ./node())"/>
									<telecom>
										<xsl:variable name="var47_resultof_adresa_spojeni" as="node()*">
											<xsl:call-template name="provisio:adresa_spojeni">
												<xsl:with-param name="as" as="node()">
													<as xmlns="urn:cz-mzcr:ns:dasta:ds4:ds_dasta">
														<xsl:sequence select="$var54_let"/>
													</as>
												</xsl:with-param>
											</xsl:call-template>
										</xsl:variable>
										<xsl:for-each select="$var47_resultof_adresa_spojeni/@id">
											<xsl:attribute name="id" namespace="" select="fn:string(.)"/>
										</xsl:for-each>
										...
										<xsl:for-each select="$var48_resultof_adresa_spojeni/ns0:extension">
											<extension>
												<xsl:sequence select="(./@node(), ./node())"/>
											</extension>
										</xsl:for-each>
										...
										<xsl:for-each select="$var49_resultof_adresa_spojeni/ns0:system">
											<system>
												<xsl:sequence select="(./@node(), ./node())"/>
											</system>
										</xsl:for-each>
										...
										<xsl:for-each select="$var50_resultof_adresa_spojeni/ns0:value">
											<value>
												<xsl:sequence select="(./@node(), ./node())"/>
											</value>
										</xsl:for-each>
										...
										<xsl:for-each select="$var51_resultof_adresa_spojeni/ns0:use">
											<use>
												<xsl:sequence select="(./@node(), ./node())"/>
											</use>
										</xsl:for-each>
										<xsl:variable name="var52_resultof_adresa_spojeni" as="node()*">
											<xsl:call-template name="provisio:adresa_spojeni">
												<xsl:with-param name="as" as="node()">
													<as xmlns="urn:cz-mzcr:ns:dasta:ds4:ds_dasta">
														<xsl:sequence select="$var54_let"/>
										...
										<xsl:for-each select="$var52_resultof_adresa_spojeni/ns0:rank">
											<rank>
												<xsl:sequence select="(./@node(), ./node())"/>
											</rank>
										</xsl:for-each>
										<xsl:variable name="var53_resultof_adresa_spojeni" as="node()*">
											<xsl:call-template name="provisio:adresa_spojeni">
												<xsl:with-param name="as" as="node()">
													<as xmlns="urn:cz-mzcr:ns:dasta:ds4:ds_dasta">
														<xsl:sequence select="$var54_let"/>
										...
										<xsl:for-each select="$var53_resultof_adresa_spojeni/ns0:period">
											<period>
												<xsl:sequence select="(./@node(), ./node())"/>
											</period>
										</xsl:for-each>
								...
								<xsl:variable name="var55_resultof_adresa" as="node()?">
									<xsl:call-template name="provisio:adresa">
										<xsl:with-param name="a" as="node()">
											<a xmlns="urn:cz-mzcr:ns:dasta:ds4:ds_dasta">
												<xsl:sequence select="(./@node(), ./node())"/>
								...
								<xsl:for-each select="$var55_resultof_adresa">
									<address>
										<xsl:sequence select="(./@node(), ./node())"/>
									</address>
								</xsl:for-each>
								...
								<language>
									<xsl:for-each select="@jazyk_klic">
										<coding>
											...
											<xsl:for-each select="$var58_cur/@jazyk_text">
												<display>
													<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
												</display>
											</xsl:for-each>
					...
					<xsl:for-each select="($var72_a)[fn:exists((./@typ)[(fn:string(.) = '3')])]">
						...
						<RelatedPerson>
									...
									<xsl:for-each select="$var71_guid">
										<xsl:for-each select="$var74_vguid">
											<xsl:for-each select="$var71_guid">
												...
												<xsl:for-each select="$var74_vguid">
													<xsl:variable name="var59_resultof_Reference_Patient" as="xs:string?">
														<xsl:call-template name="provisio:Reference_Patient">
															<xsl:with-param name="GUID" select="fn:string($var60_cur)" as="xs:string"/>
															<xsl:with-param name="VGUID" select="fn:string(.)" as="xs:string"/>
														</xsl:call-template>
													</xsl:variable>
													<xsl:for-each select="$var59_resultof_Reference_Patient">
														<xsl:attribute name="value" namespace="" select="."/>
													</xsl:for-each>
												</xsl:for-each>
											</xsl:for-each>
							...
							<xsl:for-each select="(./ns1:as)[fn:exists(($var70_cur/@typ)[(fn:string(.) = '3')])]">
								<xsl:variable name="var68_let" as="node()*" select="(./@node(), ./node())"/>
								<telecom>
									<xsl:variable name="var61_resultof_adresa_spojeni" as="node()*">
										<xsl:call-template name="provisio:adresa_spojeni">
											<xsl:with-param name="as" as="node()">
												<as xmlns="urn:cz-mzcr:ns:dasta:ds4:ds_dasta">
													<xsl:sequence select="$var68_let"/>
												</as>
											</xsl:with-param>
										</xsl:call-template>
									</xsl:variable>
									<xsl:for-each select="$var61_resultof_adresa_spojeni/@id">
										<xsl:attribute name="id" namespace="" select="fn:string(.)"/>
									</xsl:for-each>
									...
									<xsl:for-each select="$var62_resultof_adresa_spojeni/ns0:extension">
										<extension>
											<xsl:sequence select="(./@node(), ./node())"/>
										</extension>
									</xsl:for-each>
									...
									<xsl:for-each select="$var63_resultof_adresa_spojeni/ns0:system">
										<system>
											<xsl:sequence select="(./@node(), ./node())"/>
										</system>
									</xsl:for-each>
									...
									<xsl:for-each select="$var64_resultof_adresa_spojeni/ns0:value">
										<value>
											<xsl:sequence select="(./@node(), ./node())"/>
										</value>
									</xsl:for-each>
									...
									<xsl:for-each select="$var65_resultof_adresa_spojeni/ns0:use">
										<use>
											<xsl:sequence select="(./@node(), ./node())"/>
										</use>
									</xsl:for-each>
									<xsl:variable name="var66_resultof_adresa_spojeni" as="node()*">
										<xsl:call-template name="provisio:adresa_spojeni">
											<xsl:with-param name="as" as="node()">
												<as xmlns="urn:cz-mzcr:ns:dasta:ds4:ds_dasta">
													<xsl:sequence select="$var68_let"/>
									...
									<xsl:for-each select="$var66_resultof_adresa_spojeni/ns0:rank">
										<rank>
											<xsl:sequence select="(./@node(), ./node())"/>
										</rank>
									</xsl:for-each>
									<xsl:variable name="var67_resultof_adresa_spojeni" as="node()*">
										<xsl:call-template name="provisio:adresa_spojeni">
											<xsl:with-param name="as" as="node()">
												<as xmlns="urn:cz-mzcr:ns:dasta:ds4:ds_dasta">
													<xsl:sequence select="$var68_let"/>
									...
									<xsl:for-each select="$var67_resultof_adresa_spojeni/ns0:period">
										<period>
											<xsl:sequence select="(./@node(), ./node())"/>
										</period>
									</xsl:for-each>
							...
							<xsl:variable name="var69_resultof_adresa" as="node()?">
								<xsl:call-template name="provisio:adresa">
									<xsl:with-param name="a" as="node()">
										<a xmlns="urn:cz-mzcr:ns:dasta:ds4:ds_dasta">
											<xsl:sequence select="(./@node(), ./node())"/>
							...
							<xsl:for-each select="$var69_resultof_adresa">
								<address>
									<xsl:sequence select="(./@node(), ./node())"/>
								</address>
							</xsl:for-each>
	...
	<xsl:template name="provisio:fyznal">
		...
		<xsl:for-each select="$fyznalType">
			...
			<xsl:for-each select="ns2:tk_syst">
				...
				<xsl:variable name="var3_guid_tk" as="node()?" select="$var4_cur/@guid_tk"/>
				<entry xmlns="http://hl7.org/fhir">
	...
	<xsl:template name="provisio:ip">
		...
		<xsl:variable name="var3_resultof_le___all" as="node()*">
			<xsl:call-template name="provisio:le_-_all">
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
				<xsl:with-param name="ip_le" select="$var92_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_le" select="$var82_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="dat_prov" select="$var85_map_of_ip" as="node()*"/>
			</xsl:call-template>
		</xsl:variable>
		<xsl:variable name="var6_resultof_u___all" as="node()*">
			<xsl:call-template name="provisio:u_-_all">
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
				<xsl:with-param name="ip_u" select="$var86_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="dat_prov" select="$var85_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_u" select="$var79_map_of_ip" as="node()*"/>
			</xsl:call-template>
		</xsl:variable>
		<xsl:variable name="var9_resultof_fs___all" as="node()*">
			<xsl:call-template name="provisio:fs_-_all">
				<xsl:with-param name="ip_fs" select="$var90_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_fs" select="$var75_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
				<xsl:with-param name="dat_prov" select="$var85_map_of_ip" as="node()*"/>
		...
		<xsl:variable name="var12_resultof_ld___all" as="node()*">
			<xsl:call-template name="provisio:ld_-_all">
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="ip_ld" select="$var91_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_ld" select="$var78_map_of_ip" as="node()*"/>
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
				<xsl:with-param name="dat_prov" select="$var85_map_of_ip" as="node()*"/>
			</xsl:call-template>
		</xsl:variable>
		<xsl:variable name="var15_resultof_chv___all" as="node()*">
			<xsl:call-template name="provisio:chv_-_all">
				<xsl:with-param name="ip_chv" select="$var94_map_of_ip" as="node()*"/>
				<xsl:with-param name="ip_anf_anam_vyk_chv" select="$var84_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_anf_anam_vyk_chv" select="$var70_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsudat_chv" select="$var72_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
				<xsl:with-param name="dat_prov" select="$var85_map_of_ip" as="node()*"/>
		...
		<xsl:variable name="var18_resultof_oc___all" as="node()*">
			<xsl:call-template name="provisio:oc_-_all">
				...
				<xsl:with-param name="anf_anam_oc" select="$var83_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_anf_anam_oc" select="$var69_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_oc" select="$var73_map_of_ip" as="node()*"/>
		...
		<xsl:variable name="var21_resultof_h___all" as="node()*">
			<xsl:call-template name="provisio:h_-_all">
				...
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="dat_prov" select="$var85_map_of_ip" as="node()*"/>
				<xsl:with-param name="ip_h" select="$var96_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_h" select="$var76_map_of_ip" as="node()*"/>
			</xsl:call-template>
		</xsl:variable>
		<xsl:variable name="var24_resultof_fyznal___all" as="node()*">
			<xsl:call-template name="provisio:fyznal_-_all">
				<xsl:with-param name="ip_fyznal" select="$var88_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_fyznal" select="$var80_map_of_ip" as="node()*"/>
				<xsl:with-param name="dat_prov" select="$var85_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
		...
		<xsl:variable name="var30_resultof_an___all" as="node()*">
			<xsl:call-template name="provisio:an_-_all">
				<xsl:with-param name="dat_prov" select="$var85_map_of_ip" as="node()*"/>
				<xsl:with-param name="ip_an" select="$var93_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_an" select="$var74_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
			</xsl:call-template>
		...
		<xsl:variable name="var33_resultof_grav___all" as="node()*">
			<xsl:call-template name="provisio:grav_-_all">
				<xsl:with-param name="ip_grav" select="$var89_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_grav" select="$var81_map_of_ip" as="node()*"/>
				<xsl:with-param name="dat_prov" select="$var85_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
		...
		<xsl:variable name="var42_resultof_u___all" as="node()*">
			<xsl:call-template name="provisio:u_-_all">
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
				<xsl:with-param name="ip_u" select="$var86_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
		...
		<xsl:variable name="var45_resultof_anf___all" as="node()*">
			<xsl:call-template name="provisio:anf_-_all">
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
				<xsl:with-param name="ip_anf" select="$var95_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="patsumdat_anf" select="$var77_map_of_ip" as="node()*"/>
				<xsl:with-param name="dat_prov" select="$var85_map_of_ip" as="node()*"/>
			</xsl:call-template>
		</xsl:variable>
		...
		<xsl:variable name="var51_resultof_anf___all" as="node()*">
			<xsl:call-template name="provisio:anf_-_all">
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
				<xsl:with-param name="ip_anf" select="$var95_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
		...
		<xsl:variable name="var54_resultof_dg___all" as="node()*">
			<xsl:call-template name="provisio:dg_-_all">
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
				<xsl:with-param name="ip_dg" select="$var97_map_of_ip" as="node()*"/>
		...
		<xsl:variable name="var55_resultof_Composition_EU_PS" as="node()*">
			<xsl:call-template name="provisio:Composition_EU_PS">
				...
				<xsl:with-param name="sectionAllergies_ua" as="node()*">
					<xsl:for-each select="$var6_resultof_u___all">
						<xsl:variable name="var5_cur" as="node()" select="."/>
						<xsl:for-each select="(./ns0:fullUrl/@value)[fn:exists((($var5_cur/ns0:resource/ns0:AllergyIntolerance/ns0:text/xhtml:div/node())[fn:boolean(self::text())])[fn:starts-with(fn:string(.), 'AllergyIntolerance')])]">
							<xsl:variable name="var4_cur" as="node()" select="."/>
							<entry xmlns="http://hl7.org/fhir">
								<reference>
				...
				<xsl:with-param name="sectionResults_uks" as="node()*">
					<xsl:for-each select="$var27_resultof_u___all">
						...
						<xsl:for-each select="(./ns0:fullUrl/@value)[fn:exists((($var26_cur/ns0:resource/ns0:Observation/ns0:text/xhtml:div/node())[fn:boolean(self::text())])[fn:starts-with(fn:string(.), 'Observation')])]">
				...
				<xsl:with-param name="sectionMedicalDevices_uniz" as="node()*">
					...
					<xsl:for-each select="$var36_resultof_u___all">
						...
						<xsl:for-each select="(./ns0:fullUrl/@value)[fn:exists((($var35_cur/ns0:resource/ns0:DeviceUseStatement/ns0:text/xhtml:div/node())[fn:boolean(self::text())])[fn:starts-with(fn:string(.), 'DeviceUseStatement')])]">
					...
					<xsl:for-each select="$var39_resultof_u___all">
						...
						<xsl:for-each select="ns0:fullUrl/@value">
							...
							<xsl:for-each select="$var38_cur/ns0:resource/ns0:Device/ns0:meta/ns0:versionId/@value">
								<entry xmlns="http://hl7.org/fhir">
									<reference>
				...
				<xsl:with-param name="sectionAlert_urf_utm_uot" as="node()*">
					<xsl:for-each select="$var42_resultof_u___all">
						<xsl:variable name="var41_cur" as="node()" select="."/>
						<xsl:for-each select="(./ns0:fullUrl/@value)[fn:exists((($var41_cur/ns0:resource/ns0:Flag/ns0:text/xhtml:div/node())[fn:boolean(self::text())])[fn:starts-with(fn:string(.), 'Flag')])]">
							<xsl:variable name="var40_cur" as="node()" select="."/>
							<entry xmlns="http://hl7.org/fhir">
								<reference>
									<xsl:for-each select="$var41_cur/ns0:resource/ns0:Flag/ns0:meta/ns0:versionId/@value">
				...
				<xsl:with-param name="sectionProblems_anf_anam_prob" as="node()*">
					<xsl:for-each select="$var45_resultof_anf___all">
						...
						<xsl:for-each select="(./ns0:fullUrl/@value)[fn:exists((($var44_cur/ns0:resource/ns0:Condition/ns0:text/xhtml:div/node())[fn:boolean(self::text())])[fn:starts-with(fn:string(.), 'Condition')])]">
							<xsl:variable name="var43_cur" as="node()" select="."/>
							<entry xmlns="http://hl7.org/fhir">
								<reference>
									<xsl:for-each select="$var44_cur/ns0:resource/ns0:Condition/ns0:meta/ns0:versionId/@value">
				...
				<xsl:with-param name="sectionSocialHistory_anf_rao" as="node()*">
					<xsl:for-each select="$var48_resultof_anf___all">
						...
						<xsl:for-each select="(./ns0:fullUrl/@value)[fn:exists((($var47_cur/ns0:resource/ns0:FamilyMemberHistory/ns0:text/xhtml:div/node())[fn:boolean(self::text())])[fn:starts-with(fn:string(.), 'FamilyMemberHistory')])]">
							<xsl:variable name="var46_cur" as="node()" select="."/>
							<entry xmlns="http://hl7.org/fhir">
								<reference>
									<xsl:for-each select="$var47_cur/ns0:resource/ns0:FamilyMemberHistory/ns0:meta/ns0:versionId/@value">
				...
				<xsl:with-param name="sectionSocialHistory_anf_inf_infc_sa" as="node()*">
					<xsl:for-each select="$var51_resultof_anf___all">
						<xsl:variable name="var50_cur" as="node()" select="."/>
						<xsl:for-each select="(./ns0:fullUrl/@value)[fn:exists((($var50_cur/ns0:resource/ns0:Observation/ns0:text/xhtml:div/node())[fn:boolean(self::text())])[fn:starts-with(fn:string(.), 'Observation')])]">
							<xsl:variable name="var49_cur" as="node()" select="."/>
							<entry xmlns="http://hl7.org/fhir">
								<reference>
									<xsl:for-each select="$var50_cur/ns0:resource/ns0:Observation/ns0:meta/ns0:versionId/@value">
				...
				<xsl:with-param name="sectionProblems_dg" as="node()*">
					<xsl:for-each select="$var54_resultof_dg___all">
						<xsl:variable name="var53_cur" as="node()" select="."/>
						<xsl:for-each select="ns0:fullUrl/@value">
							<xsl:variable name="var52_cur" as="node()" select="."/>
							<entry xmlns="http://hl7.org/fhir">
								<reference>
									<xsl:for-each select="$var53_cur/ns0:resource/ns0:Condition/ns0:meta/ns0:versionId/@value">
										<xsl:attribute name="value" namespace="" select="fn:concat(fn:concat(xs:string(xs:anyURI(fn:string($var52_cur))), '/_history/'), fn:string(.))"/>
									</xsl:for-each>
								</reference>
							</entry>
						</xsl:for-each>
		...
		<xsl:for-each select="$var55_resultof_Composition_EU_PS">
			<entry xmlns="http://hl7.org/fhir">
				<xsl:sequence select="(./@node(), ./node())"/>
			</entry>
		</xsl:for-each>
		<xsl:variable name="var56_resultof_h___all" as="node()*">
			<xsl:call-template name="provisio:h_-_all">
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
		...
		<xsl:for-each select="$var56_resultof_h___all">
			<entry xmlns="http://hl7.org/fhir">
				<xsl:sequence select="(./@node(), ./node())"/>
			</entry>
		</xsl:for-each>
		<xsl:variable name="var57_resultof_fyznal___all" as="node()*">
			<xsl:call-template name="provisio:fyznal_-_all">
				<xsl:with-param name="ip_fyznal" select="$var88_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_fyznal" select="$var80_map_of_ip" as="node()*"/>
				<xsl:with-param name="dat_prov" select="$var85_map_of_ip" as="node()*"/>
		...
		<xsl:for-each select="$var57_resultof_fyznal___all">
			<entry xmlns="http://hl7.org/fhir">
				<xsl:sequence select="(./@node(), ./node())"/>
			</entry>
		</xsl:for-each>
		<xsl:variable name="var58_resultof_grav___all" as="node()*">
			<xsl:call-template name="provisio:grav_-_all">
				<xsl:with-param name="ip_grav" select="$var89_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_grav" select="$var81_map_of_ip" as="node()*"/>
				<xsl:with-param name="dat_prov" select="$var85_map_of_ip" as="node()*"/>
		...
		<xsl:for-each select="$var58_resultof_grav___all">
			<entry xmlns="http://hl7.org/fhir">
				<xsl:sequence select="(./@node(), ./node())"/>
			</entry>
		</xsl:for-each>
		<xsl:variable name="var59_resultof_u___all" as="node()*">
			<xsl:call-template name="provisio:u_-_all">
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
				<xsl:with-param name="ip_u" select="$var86_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
		...
		<xsl:for-each select="$var59_resultof_u___all">
			<entry xmlns="http://hl7.org/fhir">
				<xsl:sequence select="(./@node(), ./node())"/>
			</entry>
		</xsl:for-each>
		<xsl:variable name="var60_resultof_an___all" as="node()*">
			<xsl:call-template name="provisio:an_-_all">
				<xsl:with-param name="dat_prov" select="$var85_map_of_ip" as="node()*"/>
				<xsl:with-param name="ip_an" select="$var93_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_an" select="$var74_map_of_ip" as="node()*"/>
		...
		<xsl:for-each select="$var60_resultof_an___all">
			<entry xmlns="http://hl7.org/fhir">
				<xsl:sequence select="(./@node(), ./node())"/>
			</entry>
		</xsl:for-each>
		<xsl:variable name="var61_resultof_anf___all" as="node()*">
			<xsl:call-template name="provisio:anf_-_all">
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
				<xsl:with-param name="ip_anf" select="$var95_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
		...
		<xsl:for-each select="$var61_resultof_anf___all">
			<entry xmlns="http://hl7.org/fhir">
				<xsl:sequence select="(./@node(), ./node())"/>
			</entry>
		</xsl:for-each>
		<xsl:variable name="var62_resultof_oc___all" as="node()*">
			<xsl:call-template name="provisio:oc_-_all">
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
				<xsl:with-param name="dat_prov" select="$var85_map_of_ip" as="node()*"/>
				<xsl:with-param name="ip_oc" select="$var87_map_of_ip" as="node()*"/>
		...
		<xsl:for-each select="$var62_resultof_oc___all">
			<entry xmlns="http://hl7.org/fhir">
				<xsl:sequence select="(./@node(), ./node())"/>
			</entry>
		</xsl:for-each>
		<xsl:variable name="var63_resultof_dg___all" as="node()*">
			<xsl:call-template name="provisio:dg_-_all">
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
				<xsl:with-param name="ip_dg" select="$var97_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_dg" select="$var71_map_of_ip" as="node()*"/>
		...
		<xsl:for-each select="$var63_resultof_dg___all">
			<entry xmlns="http://hl7.org/fhir">
				<xsl:sequence select="(./@node(), ./node())"/>
			</entry>
		</xsl:for-each>
		<xsl:variable name="var64_resultof_le___all" as="node()*">
			<xsl:call-template name="provisio:le_-_all">
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
				<xsl:with-param name="ip_le" select="$var92_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_le" select="$var82_map_of_ip" as="node()*"/>
		...
		<xsl:for-each select="$var64_resultof_le___all">
			<entry xmlns="http://hl7.org/fhir">
				<xsl:sequence select="(./@node(), ./node())"/>
			</entry>
		</xsl:for-each>
		<xsl:variable name="var65_resultof_chv___all" as="node()*">
			<xsl:call-template name="provisio:chv_-_all">
				<xsl:with-param name="ip_chv" select="$var94_map_of_ip" as="node()*"/>
				<xsl:with-param name="ip_anf_anam_vyk_chv" select="$var84_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_anf_anam_vyk_chv" select="$var70_map_of_ip" as="node()*"/>
		...
		<xsl:for-each select="$var65_resultof_chv___all">
			<entry xmlns="http://hl7.org/fhir">
				<xsl:sequence select="(./@node(), ./node())"/>
			</entry>
		</xsl:for-each>
		<xsl:variable name="var66_resultof_ld___all" as="node()*">
			<xsl:call-template name="provisio:ld_-_all">
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="ip_ld" select="$var91_map_of_ip" as="node()*"/>
		...
		<xsl:for-each select="$var66_resultof_ld___all">
			<entry xmlns="http://hl7.org/fhir">
				<xsl:sequence select="(./@node(), ./node())"/>
			</entry>
		</xsl:for-each>
		<xsl:variable name="var67_resultof_fs___all" as="node()*">
			<xsl:call-template name="provisio:fs_-_all">
				<xsl:with-param name="ip_fs" select="$var90_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_fs" select="$var75_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
		...
		<xsl:for-each select="$var67_resultof_fs___all">
			<entry xmlns="http://hl7.org/fhir">
				<xsl:sequence select="(./@node(), ./node())"/>
			</entry>
		</xsl:for-each>
		<xsl:variable name="var68_resultof_ip_ip" as="node()*">
		...
		<xsl:for-each select="$var68_resultof_ip_ip">
			<entry xmlns="http://hl7.org/fhir">
				<xsl:sequence select="(./@node(), ./node())"/>
			</entry>
		</xsl:for-each>
						...
						<practitioner>
							<reference>
								<xsl:for-each select="$garant_dat">
									...
									<xsl:for-each select="@guid">
										<xsl:variable name="var6_cur" as="node()" select="."/>
										<xsl:variable name="var5_vguid" as="node()?" select="$var7_current/@vguid"/>
	...
	<xsl:template match="/">
		...
		<Bundle xmlns="http://hl7.org/fhir" xmlns:xhtml="http://www.w3.org/1999/xhtml">
			<meta>
				<profile>
					<xsl:attribute name="value" namespace="" select="xs:string(xs:anyURI('http://hl7.eu/fhir/eps/StructureDefinition/bundle-eu-eps'))"/>
				</profile>
			</meta>
			<identifier>
				<system>
