...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Schematron file for transaction Return PS (PDF embedded) of country A (2.16.840.1.113883.3.1937.777.11.4.29 2017-11-20T18:28:16)</title>
   ...
   <!-- Include the project schematrons related to scenario PatientSummary_L1 -->

   <!-- eHDSI-OriginalPS -->
   <pattern>
      <title>eHDSI-OriginalPS</title>
      <rule context="/">
         <assert role="warning"
                 test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '1.3.6.1.4.1.12559.11.10.1.3.1.1.7']]"
                 see="https://art-decor.ehdsi.eu/publication/epSOS/epsos-html-20200406T193244/tmp-1.3.6.1.4.1.12559.11.10.1.3.1.1.7-2018-11-14T090149.html">(eHDSI-OriginalPS): Instance is expected to have the following element: descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '1.3.6.1.4.1.12559.11.10.1.3.1.1.7']]</assert>
      </rule>
   </pattern>
   <include href="include/1.3.6.1.4.1.12559.11.10.1.3.1.1.7-2018-11-14T090149.sch"/>
   <include href="include/1.3.6.1.4.1.12559.11.10.1.3.1.1.7-2018-11-14T090149-closed.sch"/>
