...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Schematron file for transaction Return eP (PDF embedded) from country A (2.16.840.1.113883.3.1937.777.11.4.32 2017-11-21T10:26:49)</title>
   ...
   <!-- Include the project schematrons related to scenario ePrescriptionL1 -->

   <!-- eHDSI-Original-eP -->
   <pattern>
      <title>eHDSI-Original-eP</title>
      <rule context="/">
         <assert role="warning"
                 test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '1.3.6.1.4.1.12559.11.10.1.3.1.1.6']]"
                 see="https://art-decor.ehdsi.eu/publication/epSOS/epsos-html-20200406T193244/tmp-1.3.6.1.4.1.12559.11.10.1.3.1.1.6-2018-11-14T090105.html">(eHDSI-Original-eP): Instance is expected to have the following element: descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '1.3.6.1.4.1.12559.11.10.1.3.1.1.6']]</assert>
      </rule>
   </pattern>
   <include href="include/1.3.6.1.4.1.12559.11.10.1.3.1.1.6-2018-11-14T090105.sch"/>
   <include href="include/1.3.6.1.4.1.12559.11.10.1.3.1.1.6-2018-11-14T090105-closed.sch"/>
