...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Schematron file for transaction Send eD to country A (2.16.840.1.113883.3.1937.777.11.4.25 2013-11-02T00:00:00)</title>
   ...
   <!-- Include the project schematrons related to scenario eDispensation -->

   <!-- epSOS-eD -->
   <pattern>
      <title>epSOS-eD</title>
      <rule context="/">
         <assert role="warning"
                 test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '1.3.6.1.4.1.12559.11.10.1.3.1.1.2']]"
                 see="https://art-decor.ehdsi.eu/publication/epSOS/epsos-html-20200406T193244/tmp-1.3.6.1.4.1.12559.11.10.1.3.1.1.2-2020-04-06T192014.html">(epSOS-eD): Instance is expected to have the following element: descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '1.3.6.1.4.1.12559.11.10.1.3.1.1.2']]</assert>
      </rule>
   </pattern>
   <include href="include/1.3.6.1.4.1.12559.11.10.1.3.1.1.2-2020-04-06T192014.sch"/>
   <include href="include/1.3.6.1.4.1.12559.11.10.1.3.1.1.2-2020-04-06T192014-closed.sch"/>
