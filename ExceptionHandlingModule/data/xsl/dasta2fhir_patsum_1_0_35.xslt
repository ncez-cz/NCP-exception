...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ns0="http://hl7.org/fhir" xmlns:provisio="http://www.altova.com/MapForce/UDF/provisio" xmlns:vmf="http://www.altova.com/MapForce/UDF/vmf" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:ns1="urn:cz-mzcr:ns:dasta:ds4:ds_dasta" xmlns:ns2="urn:cz-mzcr:ns:dasta:ds4:ds_ip" exclude-result-prefixes="ns0 provisio vmf xs fn ns1 ns2">
	...
	<xsl:template name="provisio:anf_anam_inf">
		...
		<xsl:for-each select="$anam_infType">
			...
			<xsl:variable name="var3_http___snomed_info_sct_as_string" as="xs:string" select="xs:string(xs:anyURI('http://snomed.info/sct'))"/>
			<xsl:variable name="var4_inf_agens" as="node()*" select="ns2:inf_agens"/>
				...
				<resource>
					<Observation>
						...
						<code>
							<coding>
								<system>
									<xsl:attribute name="value" namespace="" select="$var3_http___snomed_info_sct_as_string"/>
								</system>
								<xsl:for-each select="$var4_inf_agens/ns2:kod">
									<code>
										<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
									</code>
								</xsl:for-each>
								<display>
									<xsl:for-each select="$var4_inf_agens/ns2:kod_text">
										<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
									</xsl:for-each>
								</display>
							</coding>
	...
	<xsl:template name="provisio:dg">
		...
		<xsl:for-each select="$dgzType">
			...
			<xsl:variable name="var6_diag" as="node()*" select="ns2:diag"/>
			<xsl:variable name="var7_guid" as="node()?" select="@guid"/>
			<entry xmlns="http://hl7.org/fhir">
				<xsl:for-each select="$var7_guid">
					<xsl:for-each select="$var7_guid">
	...
	<xsl:template name="provisio:chv">
		...
		<xsl:for-each select="$chvType">
			...
			<xsl:variable name="var9_chvps_text" as="node()?" select="@chvps_text"/>
			<entry xmlns="http://hl7.org/fhir">
				<xsl:for-each select="$var7_guid">
					<xsl:for-each select="$var7_guid">
				...
				<resource>
					<Procedure>
						...
						<text>
							...
							<xhtml:div>
								<xsl:for-each select="$var9_chvps_text">
									<xsl:sequence select="fn:string(.)"/>
								</xsl:for-each>
							</xhtml:div>
						</text>
	...
	<xsl:template name="provisio:fs">
		...
		<xsl:for-each select="$fsType">
			...
			<xsl:variable name="var8_text" as="node()*" select="ns2:text"/>
			<entry xmlns="http://hl7.org/fhir">
	...
	<xsl:template name="provisio:ip_ip">
		...
		<xsl:for-each select="$ip">
			...
			<xsl:variable name="var69_ipi_v" as="node()*" select="ns2:ipi_v"/>
			<xsl:variable name="var70_guid" as="node()?" select="@guid"/>
			<xsl:variable name="var71_a" as="node()*" select="ns1:a"/>
			<xsl:variable name="var72_titul_pred" as="node()*" select="ns2:titul_pred"/>
			<xsl:variable name="var73_vguid" as="node()?" select="@vguid"/>
			<xsl:variable name="var74_ipi_o" as="node()*" select="ns2:ipi_o"/>
			<xsl:variable name="var75_prijmeni" as="node()*" select="ns2:prijmeni"/>
			<entry xmlns="http://hl7.org/fhir">
				<xsl:for-each select="$var70_guid">
					<xsl:attribute name="id" namespace="" select="fn:string(.)"/>
				</xsl:for-each>
				<xsl:for-each select="$var70_guid">
					<xsl:for-each select="$var70_guid">
				...
				<resource>
					<Patient>
						...
						<meta>
							<xsl:for-each select="$var73_vguid">
								<versionId>
									<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
								</versionId>
							</xsl:for-each>
						...
						<xsl:for-each select="$var74_ipi_o/@nem_cis">
							<identifier>
								<use>
									<xsl:attribute name="value" namespace="" select="'official'"/>
								</use>
						...
						<xsl:for-each select="$var74_ipi_o/@kat_pac">
							<identifier>
								<use>
									<xsl:attribute name="value" namespace="" select="'official'"/>
								</use>
						...
						<xsl:for-each select="$var74_ipi_o/@cis_chor">
							<identifier>
								<use>
									<xsl:attribute name="value" namespace="" select="'official'"/>
								</use>
						...
						<xsl:for-each select="$var74_ipi_o/@cis_is">
							<identifier>
								<use>
									<xsl:attribute name="value" namespace="" select="'official'"/>
								</use>
						...
						<xsl:for-each select="$var69_ipi_v/@nem_cis">
							<identifier>
								<use>
									<xsl:attribute name="value" namespace="" select="'official'"/>
								</use>
						...
						<xsl:for-each select="$var69_ipi_v/@kat_pac">
							<identifier>
								<use>
									<xsl:attribute name="value" namespace="" select="'official'"/>
								</use>
						...
						<xsl:for-each select="$var69_ipi_v/@cis_chor">
							<identifier>
								<use>
									<xsl:attribute name="value" namespace="" select="'official'"/>
								</use>
						...
						<xsl:for-each select="$var69_ipi_v/@cis_is">
							<identifier>
								<use>
									<xsl:attribute name="value" namespace="" select="'MR'"/>
								</use>
	...
	<xsl:template name="provisio:le">
		...
		<xsl:for-each select="$leType">
			...
			<xsl:for-each select="ns2:lez">
				<xsl:variable name="var10_cur" as="node()" select="."/>
				<xsl:variable name="var6_guid" as="node()?" select="@guid"/>
				<xsl:variable name="var7_nazev_lek" as="node()?" select="@nazev_lek"/>
				<xsl:variable name="var8_dat_ab" as="node()?" select="$var11_cur/@dat_ab"/>
					...
					<resource>
						<MedicationAdministration>
							...
							<text>
								...
								<xhtml:div>
									<xsl:for-each select="$var7_nazev_lek">
										<xsl:sequence select="fn:string(.)"/>
									</xsl:for-each>
								</xhtml:div>
							</text>
	...
	<xsl:template name="provisio:ip">
		...
		<xsl:variable name="var4_resultof_le___all" as="node()*">
			<xsl:call-template name="provisio:le_-_all">
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
				<xsl:with-param name="ip_le" select="$var107_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_le" select="$var92_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="dat_prov" select="$var98_map_of_ip" as="node()*"/>
			</xsl:call-template>
		</xsl:variable>
		<xsl:variable name="var8_resultof_u___all" as="node()*">
			<xsl:call-template name="provisio:u_-_all">
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
				<xsl:with-param name="ip_u" select="$var111_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="dat_prov" select="$var98_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_u" select="$var90_map_of_ip" as="node()*"/>
			</xsl:call-template>
		</xsl:variable>
		<xsl:variable name="var12_resultof_fs___all" as="node()*">
			<xsl:call-template name="provisio:fs_-_all">
				<xsl:with-param name="ip_fs" select="$var110_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_fs" select="$var96_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
				<xsl:with-param name="dat_prov" select="$var98_map_of_ip" as="node()*"/>
		...
		<xsl:variable name="var16_resultof_ld___all" as="node()*">
			<xsl:call-template name="provisio:ld_-_all">
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="ip_ld" select="$var100_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_ld" select="$var95_map_of_ip" as="node()*"/>
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
				<xsl:with-param name="dat_prov" select="$var98_map_of_ip" as="node()*"/>
			</xsl:call-template>
		</xsl:variable>
		<xsl:variable name="var20_resultof_chv___all" as="node()*">
			<xsl:call-template name="provisio:chv_-_all">
				<xsl:with-param name="ip_chv" select="$var103_map_of_ip" as="node()*"/>
				<xsl:with-param name="ip_anf_anam_vyk_chv" select="$var99_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_anf_anam_vyk_chv" select="$var84_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsudat_chv" select="$var87_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
				<xsl:with-param name="dat_prov" select="$var98_map_of_ip" as="node()*"/>
		...
		<xsl:variable name="var24_resultof_oc___all" as="node()*">
			<xsl:call-template name="provisio:oc_-_all">
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
				<xsl:with-param name="dat_prov" select="$var98_map_of_ip" as="node()*"/>
				<xsl:with-param name="ip_oc" select="$var101_map_of_ip" as="node()*"/>
				...
				<xsl:with-param name="patsumdat_oc" select="$var86_map_of_ip" as="node()*"/>
		...
		<xsl:variable name="var28_resultof_h___all" as="node()*">
			<xsl:call-template name="provisio:h_-_all">
				...
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="dat_prov" select="$var98_map_of_ip" as="node()*"/>
				<xsl:with-param name="ip_h" select="$var105_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_h" select="$var88_map_of_ip" as="node()*"/>
			</xsl:call-template>
		</xsl:variable>
		<xsl:variable name="var32_resultof_fyznal___all" as="node()*">
			<xsl:call-template name="provisio:fyznal_-_all">
				<xsl:with-param name="ip_fyznal" select="$var106_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_fyznal" select="$var85_map_of_ip" as="node()*"/>
				<xsl:with-param name="dat_prov" select="$var98_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
		...
		<xsl:variable name="var40_resultof_an___all" as="node()*">
			<xsl:call-template name="provisio:an_-_all">
				<xsl:with-param name="dat_prov" select="$var98_map_of_ip" as="node()*"/>
				<xsl:with-param name="ip_an" select="$var108_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_an" select="$var89_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
			</xsl:call-template>
		...
		<xsl:variable name="var44_resultof_grav___all" as="node()*">
			<xsl:call-template name="provisio:grav_-_all">
				<xsl:with-param name="ip_grav" select="$var102_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_grav" select="$var91_map_of_ip" as="node()*"/>
				<xsl:with-param name="dat_prov" select="$var98_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
		...
		<xsl:variable name="var56_resultof_anf___all" as="node()*">
			<xsl:call-template name="provisio:anf_-_all">
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
				<xsl:with-param name="ip_anf" select="$var109_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="patsumdat_anf" select="$var93_map_of_ip" as="node()*"/>
				<xsl:with-param name="dat_prov" select="$var98_map_of_ip" as="node()*"/>
			</xsl:call-template>
		</xsl:variable>
		...
		<xsl:variable name="var68_resultof_dg___all" as="node()*">
			<xsl:call-template name="provisio:dg_-_all">
				<xsl:with-param name="patientReference" select="$patientReference" as="xs:string*"/>
				<xsl:with-param name="ip_dg" select="$var104_map_of_ip" as="node()*"/>
				<xsl:with-param name="patsumdat_dg" select="$var94_map_of_ip" as="node()*"/>
				<xsl:with-param name="organizatinReference" select="$organizatinReference" as="xs:string*"/>
				<xsl:with-param name="practitionerReference" select="$practitionerReference" as="xs:string*"/>
				<xsl:with-param name="dat_prov" select="$var98_map_of_ip" as="node()*"/>
			</xsl:call-template>
