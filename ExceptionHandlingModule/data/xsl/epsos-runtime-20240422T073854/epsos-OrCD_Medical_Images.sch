...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Schematron file for transaction Return OrCD Medical Images of country A (2.16.840.1.113883.3.1937.777.11.4.41 2021-04-30T11:16:15)</title>
   ...
   <!-- Include the project schematrons related to scenario OrCD_Medical_Images -->

   <!-- eHDSIOrCDMedicalImages -->
   <pattern>
      <title>eHDSIOrCDMedicalImages</title>
      <rule fpi="RUL-EXPEL" context="/">
         <assert role="warning"
                 test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '1.3.6.1.4.1.12559.11.10.1.3.1.1.11']]"
                 see="https://art-decor.ehdsi.eu/publication/epSOS/epsos-html-20240422T073854/tmp-1.3.6.1.4.1.12559.11.10.1.3.1.1.11-2024-04-19T100227.html">(eHDSIOrCDMedicalImages): Instance is expected to have the following element: descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '1.3.6.1.4.1.12559.11.10.1.3.1.1.11']]</assert>
      </rule>
   </pattern>
   <include href="include/1.3.6.1.4.1.12559.11.10.1.3.1.1.11-2024-04-19T100227.sch"/>
   <include href="include/1.3.6.1.4.1.12559.11.10.1.3.1.1.11-2024-04-19T100227-closed.sch"/>
