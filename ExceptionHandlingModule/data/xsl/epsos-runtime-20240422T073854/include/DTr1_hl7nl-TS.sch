...
<rule xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <assert role="error"
           ...
           see="https://art-decor.org/mediawiki/index.php?title=DTr1_hl7nl:TS">dtr1-2-hl7nl-TS: <value-of select="local-name()"/> "<value-of select="$theTS"/>" is not a valid timestamp.</assert>
</rule>
