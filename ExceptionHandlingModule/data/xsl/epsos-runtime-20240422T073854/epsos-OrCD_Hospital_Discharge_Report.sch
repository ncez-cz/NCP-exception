...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Schematron file for transaction Return OrCD Hospital Discharge Report of country A (2.16.840.1.113883.3.1937.777.11.4.35 2021-04-30T09:22:38)</title>
   ...
   <!-- Include the project schematrons related to scenario OrCD_Hospital_Discharge_Report -->

   <!-- eHDSIOrCDHospitalDischargeReport -->
   <pattern>
      <title>eHDSIOrCDHospitalDischargeReport</title>
      <rule fpi="RUL-EXPEL" context="/">
         <assert role="warning"
                 test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '1.3.6.1.4.1.12559.11.10.1.3.1.1.9']]"
                 see="https://art-decor.ehdsi.eu/publication/epSOS/epsos-html-20240422T073854/tmp-1.3.6.1.4.1.12559.11.10.1.3.1.1.9-2024-04-19T100012.html">(eHDSIOrCDHospitalDischargeReport): Instance is expected to have the following element: descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '1.3.6.1.4.1.12559.11.10.1.3.1.1.9']]</assert>
      </rule>
   </pattern>
   <include href="include/1.3.6.1.4.1.12559.11.10.1.3.1.1.9-2024-04-19T100012.sch"/>
   <include href="include/1.3.6.1.4.1.12559.11.10.1.3.1.1.9-2024-04-19T100012-closed.sch"/>
