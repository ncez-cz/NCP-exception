...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ns0="http://hl7.org/fhir" xmlns:provisio="http://www.altova.com/MapForce/UDF/provisio" xmlns:tbf="http://www.altova.com/MapForce/UDF/tbf" xmlns:vmf="http://www.altova.com/MapForce/UDF/vmf" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:xml="http://www.w3.org/XML/1998/namespace" xmlns:ns1="urn:cz-mzcr:ns:dasta:ds4:ds_dasta" xmlns:ns2="urn:cz-mzcr:ns:dasta:ds4:ds_ip" exclude-result-prefixes="ns0 provisio tbf vmf xs fn ns1 ns2">
	...
	<xsl:template name="provisio:vrk_vrkpa_vrac">
		...
		<xsl:variable name="var4_hod_citlivosti" as="node()?" select="$vrac/@hod_citlivosti"/>
		<xsl:variable name="var5_guid" as="node()?" select="$vrac/@guid"/>
				...
				<Observation>
					...
					<interpretation>
						<coding>
							...
							<code>
								<xsl:for-each select="$var4_hod_citlivosti">
									<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
								</xsl:for-each>
							</code>
							<display>
	...
	<xsl:template name="provisio:vrk_vrkpa">
		...
		<xsl:variable name="var32_dalsi_vys" as="node()?" select="$vrkpa/@dalsi_vys"/>
		<xsl:variable name="var33_https___dasta_mzcr_cz_DSAKM_ht_as_string" as="xs:string" select="xs:string(xs:anyURI('https://dasta.mzcr.cz/DSAKM.htm'))"/>
		<xsl:variable name="var34_vrac" as="node()*" select="$vrkpa/ns2:vrac"/>
		<xsl:variable name="var35_guid" as="node()?" select="$vrkpa/@guid"/>
		<xsl:variable name="var36_vrav" as="node()*" select="$vrkpa/ns2:vrav"/>
		<xsl:variable name="var37_pritomnost" as="node()?" select="$vrkpa/@pritomnost"/>
			...
			<resource>
				<Observation>
					...
					<code>
						<coding>
							<system>
								<xsl:attribute name="value" namespace="" select="$var33_https___dasta_mzcr_cz_DSAKM_ht_as_string"/>
							</system>
							<code>
					...
					<valueCodeableConcept>
						<coding>
							...
							<code>
								<xsl:for-each select="$var37_pritomnost">
									<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
								</xsl:for-each>
							</code>
							<display>
					...
					<xsl:for-each select="$var36_vrav">
					...
					<component>
						...
						<valueCodeableConcept>
							<coding>
								...
								<code>
									<xsl:for-each select="$var32_dalsi_vys">
										<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
									</xsl:for-each>
								</code>
								<display>
	...
	<xsl:template name="provisio:vrk">
		...
		<xsl:variable name="var26_sez" as="node()?" select="$vrkType/@sez"/>
		<xsl:variable name="var27_guid" as="node()?" select="$ku_z_labType/@guid"/>
		<xsl:variable name="var28_guid" as="node()?" select="$vrkType/@guid"/>
		<xsl:variable name="var25_let" as="node()*" select="($patientReference/@node(), $patientReference/node())"/>
		<entry xmlns="http://hl7.org/fhir">
			<fullUrl>
				<xsl:for-each select="$var28_guid">
					<xsl:for-each select="$var28_guid">
	...
	<xsl:template name="provisio:vrn">
		...
		<xsl:param name="ku_z_labType" select="()"/>
		<xsl:variable name="var8_nejistota" as="node()*" select="$vrnType/ns2:nejistota"/>
		<xsl:variable name="var9_skala" as="node()*" select="$vrnType/ns2:skala"/>
		<xsl:variable name="var10_guid" as="node()?" select="$ku_z_labType/@guid"/>
		<xsl:variable name="var11_guid" as="node()?" select="$vrnType/@guid"/>
		<entry xmlns="http://hl7.org/fhir">
			<fullUrl>
			...
			<resource>
				<Observation>
					...
					<xsl:for-each select="$var8_nejistota/ns2:nejist_var1/@t_nejist">
						<note>
							<text>
								<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
							</text>
					...
					<note>
						<xsl:for-each select="$var8_nejistota/ns2:nejist_var1/@h_nejist">
							<text>
								<xsl:attribute name="value" namespace="" select="xs:string(xs:decimal(fn:string(.)))"/>
							</text>
						</xsl:for-each>
					</note>
					<xsl:for-each select="$var8_nejistota/ns2:nejist_var2/@t_nejist_n">
						<note>
							<text>
								<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
							</text>
					...
					<xsl:for-each select="$var8_nejistota/ns2:nejist_var2/@h_nejist_n">
						<note>
							<text>
								<xsl:attribute name="value" namespace="" select="xs:string(xs:decimal(fn:string(.)))"/>
							</text>
					...
					<xsl:for-each select="$var8_nejistota/ns2:nejist_var2/@k_anal_n">
						<note>
							<text>
								<xsl:attribute name="value" namespace="" select="xs:string(xs:decimal(fn:string(.)))"/>
							</text>
					...
					<xsl:for-each select="$var8_nejistota/ns2:nejist_var2/@t_nejist_v">
						<note>
							<text>
								<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
							</text>
					...
					<xsl:for-each select="$var8_nejistota/ns2:nejist_var2/@h_nejist_v">
						<note>
							<text>
								<xsl:attribute name="value" namespace="" select="xs:string(xs:decimal(fn:string(.)))"/>
							</text>
					...
					<xsl:for-each select="$var8_nejistota/ns2:nejist_var2/@k_anal_v">
						<note>
							<text>
								<xsl:attribute name="value" namespace="" select="xs:string(xs:decimal(fn:string(.)))"/>
							</text>
					...
					<xsl:for-each select="$var9_skala">
						<referenceRange>
	...
	<xsl:template name="provisio:vrs">
		...
		<xsl:param name="ku_z_labType" select="()"/>
		<xsl:variable name="var8_vrs_h" as="node()*" select="$vrsType/ns2:vrs_h"/>
		<xsl:variable name="var9_guid" as="node()?" select="$ku_z_labType/@guid"/>
		<xsl:variable name="var10_https___dasta_mzcr_cz_DSAJT_ht_as_string" as="xs:string" select="xs:string(xs:anyURI('https://dasta.mzcr.cz/DSAJT.htm'))"/>
		<xsl:variable name="var11_guid" as="node()?" select="$vrsType/@guid"/>
		<entry xmlns="http://hl7.org/fhir">
			<fullUrl>
				<xsl:for-each select="$var11_guid">
					<xsl:for-each select="$var11_guid">
				...
				<Observation>
					...
					<component>
						<code>
							<coding>
								<system>
									<xsl:attribute name="value" namespace="" select="$var10_https___dasta_mzcr_cz_DSAJT_ht_as_string"/>
								</system>
								<code>
									<xsl:for-each select="$var8_vrs_h/@hodnota1_klic">
										<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
									</xsl:for-each>
								</code>
							</coding>
							<xsl:for-each select="$var8_vrs_h/@hodnota1_text">
								<text>
									<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
								</text>
							</xsl:for-each>
						...
						<valueQuantity>
							<comparator>
								<xsl:for-each select="$var8_vrs_h/@priznak2_kvant">
					...
					<component>
						<code>
							<coding>
								...
								<xsl:for-each select="$var8_vrs_h/@hodnota2_klic">
									<code>
										<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
									</code>
								</xsl:for-each>
							</coding>
							<xsl:for-each select="$var8_vrs_h/@hodnota2_text">
								<text>
									<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
								</text>
							</xsl:for-each>
						...
						<valueQuantity>
							<value>
								<xsl:for-each select="$var8_vrs_h/@hodnota2_cislo">
									<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
								</xsl:for-each>
							</value>
						</valueQuantity>
	...
	<xsl:template name="provisio:vrz">
		...
		<xsl:param name="ku_z_labType" select="()"/>
		<xsl:variable name="var6_guid" as="node()?" select="$ku_z_labType/@guid"/>
		<xsl:variable name="var7_guid" as="node()?" select="$vrzType/@guid"/>
		<entry xmlns="http://hl7.org/fhir">
			<fullUrl>
				<xsl:for-each select="$var7_guid">
					<xsl:for-each select="$var7_guid">
	...
	<xsl:template name="provisio:vrd">
		...
		<xsl:param name="ku_z_labType" select="()"/>
		<xsl:variable name="var11_guid" as="node()?" select="$vrdType/@guid"/>
		<xsl:variable name="var12_guid" as="node()?" select="$ku_z_labType/@guid"/>
		<entry xmlns="http://hl7.org/fhir">
			<fullUrl>
				<xsl:for-each select="$var11_guid">
					<xsl:for-each select="$var11_guid">
	...
	<xsl:template name="provisio:vrr">
		...
		<xsl:param name="ku_z_labType" select="()"/>
		<xsl:variable name="var7_guid" as="node()?" select="$ku_z_labType/@guid"/>
		<xsl:variable name="var8_autorizace" as="node()?" select="$vrrType/@autorizace"/>
		<xsl:variable name="var9_text" as="node()*" select="$vrrType/ns2:text"/>
		<xsl:variable name="var10_guid" as="node()?" select="$vrrType/@guid"/>
		<entry xmlns="http://hl7.org/fhir">
			<fullUrl>
				<xsl:for-each select="$var10_guid">
					<xsl:for-each select="$var10_guid">
				...
				<DiagnosticReport>
					<text>
						...
						<xhtml:div xmlns:xhtml="http://www.w3.org/1999/xhtml">
							<xsl:for-each select="$var9_text/ns2:ptext/@xml:space">
								<xsl:attribute name="xml:lang" select="fn:string(.)"/>
							</xsl:for-each>
							<xsl:for-each select="$var9_text/ns2:ptext">
	...
	<xsl:template name="provisio:vrp">
		...
		<xsl:param name="ku_z_labType" select="()"/>
		<xsl:variable name="var7_guid" as="node()?" select="$ku_z_labType/@guid"/>
		<xsl:variable name="var8_guid" as="node()?" select="$vrpType/@guid"/>
		<entry xmlns="http://hl7.org/fhir">
			<fullUrl>
				<xsl:for-each select="$var8_guid">
					<xsl:for-each select="$var8_guid">
	...
	<xsl:template name="provisio:vrb">
		...
		<xsl:param name="ku_z_labType" select="()"/>
		<xsl:variable name="var10_autorizace" as="node()?" select="$vrbType/@autorizace"/>
		<xsl:variable name="var11_guid" as="node()?" select="$vrbType/@guid"/>
		<xsl:variable name="var12_guid" as="node()?" select="$ku_z_labType/@guid"/>
		<xsl:variable name="var13_typ_vzniku" as="node()?" select="$vrbType/@typ_vzniku"/>
		<xsl:variable name="var14_misto_vzniku" as="node()?" select="$vrbType/@misto_vzniku"/>
		<entry xmlns="http://hl7.org/fhir">
			<fullUrl>
				<xsl:for-each select="$var11_guid">
					<xsl:for-each select="$var11_guid">
			...
			<resource>
				<Observation>
					...
					<performer>
						<reference>
							<xsl:for-each select="$var13_typ_vzniku">
								<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
							</xsl:for-each>
						</reference>
						<display>
					...
					<performer>
						<reference>
							<xsl:for-each select="$var14_misto_vzniku">
								<xsl:attribute name="value" namespace="" select="fn:string(.)"/>
							</xsl:for-each>
						</reference>
						<display>
